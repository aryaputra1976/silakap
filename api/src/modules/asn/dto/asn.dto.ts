...
export const createAsnSchema = z.object({
  ...
  jenisKelaminId: z.coerce.number().int().optional(),
  agamaId: z.coerce.number().int().optional(),
  statusKawinId: z.coerce.number().int().optional(),
  ...
  jenisPegawai: optionalString(100),
  ...
  jabatanStrukturaId: z.string().uuid().optional(),
  jabatanFungsionalId: z.string().uuid().optional(),
  jabatanPelaksanaId: z.string().uuid().optional(),
  tmtJabatan: z.coerce.date().optional(),
  tingkatPendidikanId: z.coerce.bigint().optional(),
  bidangPendidikanId: z.string().uuid().optional(),
