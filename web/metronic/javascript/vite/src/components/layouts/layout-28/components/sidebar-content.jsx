    ...
    <div className="grid grid-cols-2 gap-2 shrink-0">
      {items.map((item, index) => (
        <button
          ...
          className={cn(
            'cursor-pointer w-full flex flex-col items-center justify-center gap-2 shrink-0 h-[90px] rounded-lg',
            selected === index
              ? 'border-black dark:border-white border-2'
              : 'border border-border',
          )}
        >
          <div className="flex items-center justify-center p-2 rounded-md border-2 border-background bg-muted/80 shadow-[0_1px_3px_0_rgba(0,0,0,0.14)]">
